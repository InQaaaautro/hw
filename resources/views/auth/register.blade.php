                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="external_id"
                                       class="col-md-4 col-form-label text-md-right">{{ __('external_id') }}</label>

                                <div class="col-md-6">
                                    <input id="external_id" type="text"
                                           class="form-control @error('external_id') is-invalid @enderror"
                                           name="external_id"
                                           value="{{ old('external_id') }}" required autocomplete="external_id" autofocus>
